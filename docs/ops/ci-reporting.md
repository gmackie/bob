...
A missing artifact after a hard timeout or failed checkout is not evidence of
successful checks. Rerun or investigate the failed job; do not create a success
payload. Replaying a report does not rerun tests or change the original native
