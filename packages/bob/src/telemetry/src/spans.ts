...
// Embedding spans moved to @gmacko/core/telemetry so OODA's oracle can emit
// them without importing @bob/* — see docs/architecture/product-boundary.md.
// Re-exported here so this package's public surface is unchanged and there is
// exactly one definition.
export {
  traceEmbedding,
  type EmbeddingContext,
} from "@gmacko/core/telemetry";
