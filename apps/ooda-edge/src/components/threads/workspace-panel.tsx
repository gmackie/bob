...
export function WorkspacePanel({ threadSlug }: WorkspacePanelProps) {
  ...
  // Note: threads.listNotes is NOT on the edge router (filesystem-dependent).
  // The workspace panel will show empty on the edge app until this route
  // is wired through the runner in a future phase.
  // We use a no-op query that returns an empty array.
