 ...
 *
 * The server's NOTIFY payloads only include primary keys + minimal metadata.
 * Richer fields below (args, result, duration_ms, status) are optional and
 * only populate once the producer side joins the full row into the NOTIFY payload.
 *
