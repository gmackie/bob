...
export default async function LoginPage() {
  ...
  return (
    <main className="relative isolate min-h-screen overflow-hidden bg-[#05070f] px-4 py-16 text-slate-50">
      ...
      <div className="mx-auto grid w-full max-w-5xl items-center gap-10 rounded-[28px] border border-white/15 bg-white/[0.04] p-8 shadow-[0_26px_90px_rgba(0,0,0,.7)] backdrop-blur-xl md:grid-cols-2 md:p-10">
        <section className="space-y-6">
          <p className="inline-flex rounded-full border border-cyan-300/25 bg-cyan-300/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.18em] text-cyan-200">
            AI command center
          </p>
          <h1 className="text-4xl font-semibold tracking-tight md:text-5xl">
            Bob Command Dashboard
          </h1>
          <p className="max-w-md text-sm leading-relaxed text-slate-200/85 md:text-base">
