    ...
    applyRuntimeServiceEnv(
      {
        ...
        SKILLFLEET_ORIGIN_URL: "https://llm.gmac.io",
        SKILLFLEET_HERMES_READ_SECRET: "skillfleet-read-secret",
        SKILLFLEET_ACCESS_CLIENT_ID: "access-client-id",
        SKILLFLEET_ACCESS_CLIENT_SECRET: "access-client-secret",
        FORGEGRAPH_API_URL: "https://forgegraf.com",
        FORGEGRAPH_API_KEY: "forge-key",
        FORGEGRAPH_CONTEXT_APPS: "bob,ooda",
        FORGEGRAPH_TRACE_API_URL: "https://forgegraf.com",
        FORGEGRAPH_TRACE_API_TOKEN: "presence-only-token",
