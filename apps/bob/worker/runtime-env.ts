...
interface RuntimeEnv {
  ...
  SKILLFLEET_ORIGIN_URL?: unknown;
  SKILLFLEET_HERMES_READ_SECRET?: unknown;
  SKILLFLEET_ACCESS_CLIENT_ID?: unknown;
  SKILLFLEET_ACCESS_CLIENT_SECRET?: unknown;
  FORGEGRAPH_API_URL?: unknown;
  FORGEGRAPH_API_KEY?: unknown;
  FORGEGRAPH_CONTEXT_APPS?: unknown;
  FORGEGRAPH_TRACE_API_URL?: unknown;
  FORGEGRAPH_TRACE_API_TOKEN?: unknown;
  ...
  HERMES_BOB_WORKSPACE_ID?: unknown;
...
export function applyRuntimeServiceEnv(
  ...
  for (const key of [
    ...
    "SKILLFLEET_ORIGIN_URL",
    "SKILLFLEET_HERMES_READ_SECRET",
    "SKILLFLEET_ACCESS_CLIENT_ID",
    "SKILLFLEET_ACCESS_CLIENT_SECRET",
    "FORGEGRAPH_API_URL",
    "FORGEGRAPH_API_KEY",
    "FORGEGRAPH_CONTEXT_APPS",
    "FORGEGRAPH_TRACE_API_URL",
    "FORGEGRAPH_TRACE_API_TOKEN",
    "HERMES_ORIGIN_TOKEN",
    "HERMES_PROXY_ORIGIN_TOKEN",
    "HERMES_ORIGIN_URL",
    "HERMES_OPERATOR_USER_IDS",
    "HERMES_OPERATOR_OWNER_USER_ID",
    "HERMES_BOB_WORKSPACE_ID",
