...
type ErrorAction =
  ...
  | {
      type: "CLEAR_ERRORS_BY_CONTEXT";
      payload: Partial<NonNullable<AppError["context"]>>;
    };
...
interface ErrorContextValue {
  ...
  clearErrorsByContext: (
    context: Partial<NonNullable<AppError["context"]>>,
  ) => void;
...
export const ErrorProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const clearErrorsByContext = useCallback(
    (context: Partial<NonNullable<AppError["context"]>>) => {
