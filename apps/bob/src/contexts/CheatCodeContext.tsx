...
const CheatCodeContext = createContext<CheatCodeContextType | undefined>(
  undefined,
);
...
export const CheatCodeProvider: React.FC<CheatCodeProviderProps> = ({
  children,
}) => {
