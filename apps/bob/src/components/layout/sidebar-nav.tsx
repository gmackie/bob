  ...
  settings: () => (
    <svg className="size-[15px]" viewBox="0 0 15 15" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7.5 10a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Zm0-1a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6.5 1h2l.35 1.76a4.98 4.98 0 0 1 1.34.78l1.7-.57 1 1.73-1.34 1.19a5.06 5.06 0 0 1 0 1.55l1.34 1.19-1 1.73-1.7-.57a4.98 4.98 0 0 1-1.34.78L8.5 14h-2l-.35-1.76a4.98 4.98 0 0 1-1.34-.78l-1.7.57-1-1.73 1.34-1.19a5.06 5.06 0 0 1 0-1.55L2.11 6.37l1-1.73 1.7.57a4.98 4.98 0 0 1 1.34-.78L6.5 1Zm.82 1-.28 1.4-.5.18a3.98 3.98 0 0 0-1.07.62l-.41.34-1.36-.45-.32.55 1.07.95-.09.53a4.06 4.06 0 0 0 0 1.24l.09.53-1.07.95.32.55 1.36-.45.41.34c.32.26.68.47 1.07.62l.5.18.28 1.4h.64l.28-1.4.5-.18a3.98 3.98 0 0 0 1.07-.62l.41-.34 1.36.45.32-.55-1.07-.95.09-.53a4.06 4.06 0 0 0 0-1.24l-.09-.53 1.07-.95-.32-.55-1.36.45-.41-.34a3.98 3.98 0 0 0-1.07-.62l-.5-.18L7.96 2h-.64Z"
      />
    </svg>
  ),
};
