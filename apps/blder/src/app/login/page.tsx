...
export default async function LoginPage() {
  ...
  return (
    <main className="bg-background text-foreground relative isolate min-h-screen overflow-hidden px-4 py-16">
      ...
      <div className="border-border bg-accent mx-auto grid w-full max-w-5xl items-center gap-10 rounded-[28px] border p-8 shadow-[0_26px_90px_rgba(0,0,0,.7)] backdrop-blur-xl md:grid-cols-2 md:p-10">
        <section className="space-y-6">
          <p className="inline-flex rounded-full border border-cyan-300/25 bg-cyan-300/10 px-3 py-1 text-xs font-medium tracking-[0.18em] text-cyan-600 uppercase dark:text-cyan-200">
            AI command center
          </p>
          ...
          <p className="text-muted-foreground max-w-md text-sm leading-relaxed md:text-base">
            A streamlined control room for orchestrating AI agents,
            repositories, and worktrees across your full development stack.
          </p>
